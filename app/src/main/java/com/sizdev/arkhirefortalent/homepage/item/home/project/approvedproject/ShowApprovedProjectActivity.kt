...
class ShowApprovedProjectActivity : AppCompatActivity(), ProjectContract.View {
    ...
    override fun addProjectList(list: List<ProjectModel>) {
        (binding.rvShowApprovedProject.adapter as ProjectAdapter).addList(list)
    ...
    override fun setRefreshManager() {
        ...
        handler.post(object : Runnable {
            override fun run() {
                presenter?.getApprovedProject(accountID!!)
    ...
    override fun setRecyclerView() {
        binding.rvShowApprovedProject.adapter = ProjectAdapter()
